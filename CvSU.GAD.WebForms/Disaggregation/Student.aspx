...
<div class="container-fluid">
    <h1 class="h3 mb-2 text-gray-800">Student Sex Disaggregation</h1>
			...
			<div class="card shadow mb-4">
				<div class="card-body form">
					...
					<div class="form-group">
						...
						<select runat="server" class="form-control required selectProgram" id="selectProgram" aria-describedby="programError">
							<option selected disabled value="">Select Program</option>
						</select>
						<small id="programError" class="invalid-feedback">This field is required.</small>
					</div>
					<div class="row">
						<div class="col-6">
							<div class="form-group">
