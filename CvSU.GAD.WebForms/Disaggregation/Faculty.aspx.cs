...
namespace CvSU.GAD.WebForms.Disaggregation
{
    public partial class Faculty : CustomPage
    {
		...
		private void LoadJSData()
		{
			...
			{
				disaggregations = DisaggregationConnector.GetFacultyDisaggregation();
			}
			else
			{
				disaggregations = DisaggregationConnector.GetFacultyDisaggregation().Where(d => d.AccountID == CurrentAccount.AccountID).ToList();
			}
		...
		protected void CreateBtn_Click(object sender, EventArgs e)
		{
			...
			{
				ShowSuccessModal("Success", "Data successfully added!", "OK", "/disaggregation/faculty.aspx");
			}
			else
			{
		...
		protected void DeleteBtn_Click(object sender, EventArgs e)
		{
			...
			if (string.IsNullOrEmpty(message))
			{
				ShowSuccessModal("Success", "Data successfully deleted!", "OK", "/disaggregation/faculty.aspx");
			}
			else
			{
				ShowErrorModal("Oops...", message, "OK", "#");
