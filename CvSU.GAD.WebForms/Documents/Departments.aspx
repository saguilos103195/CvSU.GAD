<%@ Page Title="" Language="C#" MasterPageFile="~/GAD.Master" AutoEventWireup="true" CodeBehind="Departments.aspx.cs" Inherits="CvSU.GAD.WebForms.Documents.Departments" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
<script src="/Content/Scripts/departments.js" type="text/javascript"></script>
...
<div class="container-fluid">
    <h1 class="h3 mb-2 text-gray-800">Depratments</h1>
