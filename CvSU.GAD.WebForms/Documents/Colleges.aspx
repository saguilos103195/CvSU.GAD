<%@ Page Title="" Language="C#" MasterPageFile="~/GAD.Master" AutoEventWireup="true" CodeBehind="Colleges.aspx.cs" Inherits="CvSU.GAD.WebForms.Documents.Colleges" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
<script src="/Content/Scripts/colleges.js" type="text/javascript"></script>
			...
			<div class="card shadow mb-4">
				<div class="card-body form">
					...
					<div class="form-check mb-4">
						<input type="checkbox" runat="server" class="form-check-input checkBoxMain" id="checkBoxMain">
						<label class="form-check-label" for="checkBoxMain">Main Campus</label>
					</div>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="card-body form-modal">
					...
					<div class="form-check mb-4">
						<input type="checkbox" runat="server" class="form-check-input checkBoxMainEdit" id="checkBoxMainEdit">
						<label class="form-check-label" for="checkBoxMainEdit">Main Campus</label>
					</div>
				</div>
			</div>
