	...
	public partial class Index : CustomPage
	{
		...
		protected void LoginBtn_Click(object sender, EventArgs e)
		{
			...
			if (response.Item1)
			{
				...
				showAlert = "<script type=\"text/javascript\"> toggleMasterAlert('far fa-check-circle', '#51d487', 'Success', 'Account Login Verified!', 'OK', '#009efb', '" + (Account.Status.ToLower() == "new" ? "accounts/setup.aspx" : "dashboard.aspx") + "');  </script>";
			}
			else
			{
